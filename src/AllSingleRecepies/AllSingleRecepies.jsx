...
const AllSingleRecepies = ({ each }) => {
  ...
  return (
    <div>
      <div className="my-6">
        <div className="block rounded-lg bg-neutral-100 text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <div className="p-6">
            <h5 className="mb-4 md:text-2xl text-lg font-semibold leading-tight text-neutral-800 dark:text-neutral-50">
              {recipe_name}
            </h5>
